          ...
          <div className="form-classes">
            <div className="rows-row">
              ...
              <select
                ...
                placeholder="Select"
                name="select"
                aria-label="Selection of Services"
                alt="Selection of Services"
              >
                <option value disabled selected hidden required>
                  Services Needed
                </option>
                <option
                  value=" Dry Wall Painting & Repair"
                  style={{ margin: "10px" }}
                >
                ...
                <option
                  value="Exterior  & Interior Painting"
                  style={{ margin: "10px" }}
                >
                  Exterior & Interior Painting
                </option>
                <option
                  value=" Deck Sealing & Deck Staining"
                  style={{ margin: "10px" }}
                >
